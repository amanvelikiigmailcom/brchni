export function BorchaniLogo(props: React.SVGProps<SVGSVGElement>) {
	return (
		<svg
		...
		>
			...
			<path
				...
				fillRule="evenodd"
				clipRule="evenodd"
				d="M7 6h9c2.8 0 4.5 1.6 4.5 4 0 1.4-.7 2.6-1.8 3.2 1.4.7 2.3 2 2.3 3.7 0 2.7-1.9 4.6-5.2 4.6H7V6zm3 6.5h5c1.5 0 2.2-.8 2.2-1.8S16.5 9 15 9h-5v3.5zm0 6.5h5.3c1.8 0 2.7-.9 2.7-2.1 0-1.3-.9-2.1-2.7-2.1H10V19z"
			/>
		</svg>
	);
}
